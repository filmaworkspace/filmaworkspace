...
// ─────────────────────────────────────────────────────────────────────────────
// Contenido de "Categorías" (moneda + apartados ATL/BTL), reutilizado tanto
// como pestaña del modal de Librería (ver BudgetingLibraryModal) como en la
// ruta /budgeting/{draftId}/categories, si algo enlaza directo ahí.
// ─────────────────────────────────────────────────────────────────────────────

export default function BudgetingCategoriesPanel({ draftId }: { draftId: string }) {
  const { user } = useUser();
    ...
    <div className="space-y-7">
      ...
      <div>
        <div className="flex items-center justify-between mb-2.5">
          ...
          <button
            ...
            style={{ background: enabled ? "#E86F4A" : "#e2e8f0" }}
          >
      ...
      {modalCat !== undefined && (
        <div
          ...
          onMouseDown={(e) => { if (e.target === e.currentTarget) setModalCat(undefined); }}
        >
