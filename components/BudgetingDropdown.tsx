        ...
        >
          {options.map((o) => (
            <button
              ...
              className={`w-full flex items-center justify-between gap-3 px-3.5 py-2 text-sm text-left whitespace-nowrap hover:bg-slate-50 transition-colors ${o.value === value ? "font-medium text-[#A855F7]" : "text-slate-700"}`}
            >
              {o.label}
