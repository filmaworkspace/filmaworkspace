...
// cambiaron de importe entre ellos.
// ─────────────────────────────────────────────────────────────────────────────

const CURRENT = "__current__";

export default function BudgetingVersionsPage() {
  ...
  return (
    <div className="w-full px-10 py-6 max-w-3xl">
      <h1 className="text-sm font-semibold mb-4" style={{ color: "#1D201F" }}>Versiones</h1>
