...
export default function InvoicesPage() {
  ...
  }, [id, permissions.canViewAllPOs, permissions.canViewDepartmentPOs, permissions.canViewOwnPOs, permissions.department, permissions.userId]);
  ...
  }, [invoices, searchTerm, statusFilter, typeFilter, showUncodedOnly]);
      ...
      <main className="px-24 py-8">
        ...
        {filteredInvoices.length === 0 ? (
          <div className="border-2 border-dashed border-slate-200 rounded-2xl p-16 text-center">
            ...
            <p className="text-slate-500 text-sm">{searchTerm || statusFilter !== "all" || typeFilter !== "all" || showUncodedOnly ? "Prueba a ajustar los filtros de búsqueda" : "Sube tu primer documento para empezar"}</p>
          </div>
        ) : (
